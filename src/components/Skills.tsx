  ...
  const skillCategories = [
    {
      ...
      icon: Code,
      skills: ["Python", "TypeScript", "Java","Git", "Docker", "Azure DevOps"],
      color: "blue"
    },
    {
      title: "AI & Machine Learning",
      icon: Brain,
      skills: ["LLMs", "Fine-Tuning", "RAG", "NLP", "TensorFlow", "Hugging Face"],
      color: "purple"
    },
    {
      title: "Frameworks",
      icon: Cpu,
      skills: ["FastAPI", "Flask","Angular","MSSQL", "MongoDB", "ChromaDB", "Azure Blob",],
      color: "green"
    }
