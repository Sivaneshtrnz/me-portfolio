        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-white mb-4">Me !</h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                {/* I'm a Software Developer with 2 years of experience specializing in AI-powered applications 
                ...
                I am intutive person with a knack of solving problems who gets happily lost in the "why" behind things. I love taking a problem apart, turning it inside out, and figuring out how all the pieces fit - or should fit.
                 And I'm a huge tech fan, always excited by what's next. I'm especially drawn to the field Artificiall intelligence 
              </p>
              <p className="text-gray-400 leading-relaxed">
                ...
                Currently building AI powered Intellgent systems such as integratable domain based chatbots, Inteligent data extractors.
